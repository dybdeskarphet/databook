...
def fetch_covtype(*, data_home=..., download_if_missing=..., random_state=..., shuffle=..., return_X_y=..., as_frame=..., n_retries=..., delay=...): # -> tuple[DataFrame | ndarray[_AnyShape, dtype[Any]] | Any, Series[Any] | DataFrame | ndarray[_AnyShape, dtype[signedinteger[_32Bit]]] | Any] | Bunch:
