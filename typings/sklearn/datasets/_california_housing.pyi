...
def fetch_california_housing(*, data_home=..., download_if_missing=..., return_X_y=..., as_frame=..., n_retries=..., delay=...): # -> tuple[DataFrame | ndarray[_AnyShape, dtype[float64]] | Any, Series[Any] | DataFrame | NDArray[float64] | Any] | Bunch:
