...
"""
@validate_params({ "n_samples": [Interval(Integral, 1, None, closed="left")],"n_features": [Interval(Integral, 1, None, closed="left")],"n_informative": [Interval(Integral, 1, None, closed="left")],"n_redundant": [Interval(Integral, 0, None, closed="left")],"n_repeated": [Interval(Integral, 0, None, closed="left")],"n_classes": [Interval(Integral, 1, None, closed="left")],"n_clusters_per_class": [Interval(Integral, 1, None, closed="left")],"weights": ["array-like", None],"flip_y": [Interval(Real, 0, 1, closed="both")],"class_sep": [Interval(Real, 0, None, closed="neither")],"hypercube": ["boolean"],"shift": [Interval(Real, None, None, closed="neither"), "array-like", None],"scale": [Interval(Real, 0, None, closed="neither"), "array-like", None],"shuffle": ["boolean"],"random_state": ["random_state"],"return_X_y": ["boolean"] }, prefer_skip_nested_validation=True)
def make_classification(n_samples=..., n_features=..., *, n_informative=..., n_redundant=..., n_repeated=..., n_classes=..., n_clusters_per_class=..., weights=..., flip_y=..., class_sep=..., hypercube=..., shift=..., scale=..., shuffle=..., random_state=..., return_X_y=...): # -> tuple[Any | list[Any] | ndarray[tuple[int, int], dtype[float64]], Any | list[Any] | _Array1D[Any]] | Bunch:
...
def make_multilabel_classification(n_samples=..., n_features=..., *, n_classes=..., n_labels=..., length=..., allow_unlabeled=..., sparse=..., return_indicator=..., return_distributions=..., random_state=...): # -> tuple[Any | csr_matrix, Any | csr_matrix | list[Any], Any, Any] | tuple[Any | csr_matrix, Any | csr_matrix | list[Any]]:
...
def make_hastie_10_2(n_samples=..., *, random_state=...): # -> tuple[ndarray[tuple[int, int], dtype[float64]], Any]:
...
def make_regression(n_samples=..., n_features=..., *, n_informative=..., n_targets=..., bias=..., effective_rank=..., tail_strength=..., noise=..., shuffle=..., coef=..., random_state=...): # -> tuple[Any | list[Any] | NDArray[float64], NDArray[Any], NDArray[float64]] | tuple[Any | list[Any] | NDArray[float64], NDArray[Any]]:
...
def make_circles(n_samples=..., *, shuffle=..., noise=..., random_state=..., factor=...): # -> tuple[Any | list[Any] | ndarray[_AnyShape, dtype[Any]], Any | list[Any] | NDArray[signedinteger[_NBitIntP]]]:
...
def make_moons(n_samples=..., *, shuffle=..., noise=..., random_state=...): # -> tuple[Any | list[Any] | ndarray[_AnyShape, dtype[Any]], Any | list[Any] | NDArray[signedinteger[_NBitIntP]]]:
...
def make_blobs(n_samples=..., n_features=..., *, centers=..., cluster_std=..., center_box=..., shuffle=..., random_state=..., return_centers=...): # -> tuple[Any | list[Any] | _Array[tuple[int, int], float64], Any | list[Any] | _Array[tuple[int], Any], NDArray[float64] | Any] | tuple[Any | list[Any] | _Array[tuple[int, int], float64], Any | list[Any] | _Array[tuple[int], Any]]:
...
@validate_params({ "n_samples": [Interval(Integral, 1, None, closed="left")],"n_features": [Interval(Integral, 5, None, closed="left")],"noise": [Interval(Real, 0, None, closed="left")],"random_state": ["random_state"] }, prefer_skip_nested_validation=True)
def make_friedman1(n_samples=..., n_features=..., *, noise=..., random_state=...): # -> tuple[NDArray[float64], NDArray[float64]]:
...
def make_friedman2(n_samples=..., *, noise=..., random_state=...): # -> tuple[NDArray[float64], NDArray[float64]]:
...
@validate_params({ "n_samples": [Interval(Integral, 1, None, closed="left")],"noise": [Interval(Real, 0, None, closed="left")],"random_state": ["random_state"] }, prefer_skip_nested_validation=True)
def make_friedman3(n_samples=..., *, noise=..., random_state=...): # -> tuple[NDArray[float64], NDArray[float64]]:
...
def make_low_rank_matrix(n_samples=..., n_features=..., *, effective_rank=..., tail_strength=..., random_state=...): # -> Any:
...
def make_sparse_coded_signal(n_samples, *, n_components, n_features, n_nonzero_coefs, random_state=...): # -> map[NDArray[float64]]:
...
def make_sparse_uncorrelated(n_samples=..., n_features=..., *, random_state=...): # -> tuple[NDArray[float64], NDArray[float64]]:
...
def make_spd_matrix(n_dim, *, random_state=...): # -> Any:
...
def make_sparse_spd_matrix(n_dim=..., *, alpha=..., norm_diag=..., smallest_coef=..., largest_coef=..., sparse_format=..., random_state=...): # -> Any:
...
def make_swiss_roll(n_samples=..., *, noise=..., random_state=..., hole=...): # -> tuple[ndarray[_AnyShape, dtype[float64]], NDArray[float64]]:
...
@validate_params({ "n_samples": [Interval(Integral, 1, None, closed="left")],"noise": [Interval(Real, 0, None, closed="left")],"random_state": ["random_state"] }, prefer_skip_nested_validation=True)
def make_s_curve(n_samples=..., *, noise=..., random_state=...): # -> tuple[ndarray[tuple[int, int], dtype[float64]], NDArray[float64]]:
...
def make_gaussian_quantiles(*, mean=..., cov=..., n_samples=..., n_features=..., n_classes=..., shuffle=..., random_state=...): # -> tuple[Any | list[Any] | ndarray[_AnyShape, dtype[float64]], Any | list[Any] | NDArray[signedinteger[Any]]]:
...
def make_biclusters(shape, n_clusters, *, noise=..., minval=..., maxval=..., shuffle=..., random_state=...): # -> tuple[ndarray[_AnyShape, dtype[float64]] | ndarray[tuple[int], dtype[float64]], NDArray[Any], NDArray[Any]]:
...
def make_checkerboard(shape, n_clusters, *, noise=..., minval=..., maxval=..., shuffle=..., random_state=...): # -> tuple[ndarray[_AnyShape, dtype[float64]] | ndarray[tuple[int], dtype[float64]], NDArray[Any], NDArray[Any]]:
