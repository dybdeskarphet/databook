...
def load_arff_from_gzip_file(gzip_file, parser, output_type, openml_columns_info, feature_names_to_select, target_names_to_select, shape=..., read_csv_kwargs=...): # -> tuple[Any | ndarray[_AnyShape, dtype[Any]], Any | ndarray[tuple[int], dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | None, DataFrame | Any, None] | tuple[Any | ndarray[_AnyShape, dtype[Any]], Any | ndarray[tuple[int], dtype[Any]] | ndarray[_AnyShape, dtype[Any]] | None, None, dict[Any, list[Any]]] | tuple[Any, Any | None, Any, None] | tuple[Any, Any, None, dict[Any, list[Any]]]:
