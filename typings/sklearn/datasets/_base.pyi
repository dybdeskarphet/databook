...
@validate_params({ "container_path": [str, os.PathLike],"description": [str, None],"categories": [list, None],"load_content": ["boolean"],"shuffle": ["boolean"],"encoding": [str, None],"decode_error": [StrOptions("strict", "ignore", "replace")],"random_state": ["random_state"],"allowed_extensions": [list, None] }, prefer_skip_nested_validation=True)
def load_files(container_path, *, description=..., categories=..., load_content=..., shuffle=..., encoding=..., decode_error=..., random_state=..., allowed_extensions=...): # -> Bunch:
...
def load_csv_data(data_file_name, *, data_module=..., descr_file_name=..., descr_module=..., encoding=...): # -> tuple[_Array[tuple[int, int], float64], _Array[tuple[int], Any], NDArray[Any]] | tuple[_Array[tuple[int, int], float64], _Array[tuple[int], Any], NDArray[Any], Any]:
...
def load_gzip_compressed_csv_data(data_file_name, *, data_module=..., descr_file_name=..., descr_module=..., encoding=..., **kwargs): # -> NDArray[float64] | tuple[NDArray[float64], Any]:
...
def load_descr(descr_file_name, *, descr_module=..., encoding=...):
...
def load_wine(*, return_X_y=..., as_frame=...): # -> tuple[DataFrame | _Array[tuple[int, int], float64], Series[Any] | DataFrame | _Array[tuple[int], Any]] | Bunch:
...
@validate_params({ "return_X_y": ["boolean"],"as_frame": ["boolean"] }, prefer_skip_nested_validation=True)
def load_iris(*, return_X_y=..., as_frame=...): # -> tuple[DataFrame | _Array[tuple[int, int], float64], Series[Any] | DataFrame | _Array[tuple[int], Any]] | Bunch:
...
@validate_params({ "return_X_y": ["boolean"],"as_frame": ["boolean"] }, prefer_skip_nested_validation=True)
def load_breast_cancer(*, return_X_y=..., as_frame=...): # -> tuple[DataFrame | _Array[tuple[int, int], float64], Series[Any] | DataFrame | _Array[tuple[int], Any]] | Bunch:
...
def load_digits(*, n_class=..., return_X_y=..., as_frame=...): # -> tuple[DataFrame | Any | ndarray[_AnyShape, dtype[float64]], Series[Any] | DataFrame | ndarray[_AnyShape, dtype[Any]] | Any] | Bunch:
...
@validate_params({ "return_X_y": ["boolean"],"as_frame": ["boolean"],"scaled": ["boolean"] }, prefer_skip_nested_validation=True)
def load_diabetes(*, return_X_y=..., as_frame=..., scaled=...): # -> tuple[DataFrame | Any | NDArray[float64] | tuple[NDArray[float64], Any], Series[Any] | DataFrame | NDArray[float64] | tuple[NDArray[float64], Any]] | Bunch:
...
@validate_params({ "return_X_y": ["boolean"],"as_frame": ["boolean"] }, prefer_skip_nested_validation=True)
def load_linnerud(*, return_X_y=..., as_frame=...): # -> tuple[DataFrame | NDArray[float64], Series[Any] | DataFrame | NDArray[float64]] | Bunch:
...
def fetch_file(url, folder=..., local_filename=..., sha256=..., n_retries=..., delay=...):
