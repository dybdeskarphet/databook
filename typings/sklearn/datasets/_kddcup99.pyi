...
def fetch_kddcup99(*, subset=..., data_home=..., shuffle=..., random_state=..., percent10=..., download_if_missing=..., return_X_y=..., as_frame=..., n_retries=..., delay=...): # -> tuple[DataFrame | Any | list[Any], Any | list[Any]] | Bunch:
