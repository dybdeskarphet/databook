...
from .base import BaseEstimator, ClassifierMixin, MetaEstimatorMixin, MultiOutputMixin, _fit_context
...
case.
"""
__all__ = ["OneVsOneClassifier", "OneVsRestClassifier", "OutputCodeClassifier"]
class _ConstantPredictor(BaseEstimator):
    """Helper predictor to be used when only one class is present."""
    def fit(self, X, y): # -> Self:
        ...
    
    def predict(self, X): # -> ndarray[tuple[int], dtype[Any]]:
        ...
    
    def decision_function(self, X): # -> ndarray[tuple[int], dtype[Any]]:
        ...
...
class OneVsRestClassifier(MultiOutputMixin, ClassifierMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    def __init__(self, estimator, *, n_jobs=..., verbose=...) -> None:
        ...
    ...
    @_fit_context(prefer_skip_nested_validation=False)
    def partial_fit(self, X, y, classes=..., **partial_fit_params): # -> Self:
    ...
    def predict(self, X): # -> Any | csr_matrix | ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    ...
    def decision_function(self, X): # -> NDArray[Any]:
...
class OneVsOneClassifier(MetaEstimatorMixin, ClassifierMixin, BaseEstimator):
    ...
    def predict(self, X): # -> ndarray[_AnyShape, dtype[Any]]:
    ...
    def decision_function(self, X): # -> ndarray[_AnyShape, dtype[float64]]:
