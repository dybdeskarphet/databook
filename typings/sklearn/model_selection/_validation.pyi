...
def cross_val_predict(estimator, X, y=..., *, groups=..., cv=..., n_jobs=..., verbose=..., params=..., pre_dispatch=..., method=...): # -> list[Any] | Any:
...
def permutation_test_score(estimator, X, y, *, groups=..., cv=..., n_permutations=..., n_jobs=..., random_state=..., verbose=..., scoring=..., fit_params=..., params=...): # -> tuple[floating[Any], NDArray[Any], float64]:
...
def learning_curve(estimator, X, y, *, groups=..., train_sizes=..., cv=..., scoring=..., exploit_incremental_learning=..., n_jobs=..., pre_dispatch=..., verbose=..., shuffle=..., random_state=..., error_score=..., return_times=..., fit_params=..., params=...): # -> tuple[NDArray[Any], Any | ndarray[tuple[int, int], dtype[Any]], Any | ndarray[tuple[int, int], dtype[Any]], Any | ndarray[tuple[int, int], dtype[Any]], Any | ndarray[tuple[int, int], dtype[Any]]] | tuple[NDArray[Any], Any | ndarray[tuple[int, int], dtype[Any]], Any | ndarray[tuple[int, int], dtype[Any]]]:
    """Learning curve.
...
def validation_curve(estimator, X, y, *, param_name, param_range, groups=..., cv=..., scoring=..., n_jobs=..., pre_dispatch=..., verbose=..., error_score=..., fit_params=..., params=...): # -> tuple[ndarray[tuple[int, int], dtype[Any]] | Any, ndarray[tuple[int, int], dtype[Any]] | Any]:
    """Validation curve.
