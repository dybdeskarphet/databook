...
class BaseCrossValidator(_MetadataRequester, metaclass=ABCMeta):
    ...
    """
    __metadata_request__split = ...
    def split(self, X, y=..., groups=...): # -> Generator[tuple[ndarray[_AnyShape, dtype[signedinteger[Any]]], ndarray[_AnyShape, dtype[signedinteger[Any]]]], Any, None]:
        """Generate indices to split data into training and test set.
...
class BaseShuffleSplit(_MetadataRequester, metaclass=ABCMeta):
    ...
    def split(self, X, y=..., groups=...): # -> Generator[tuple[ndarray[_AnyShape, dtype[long]], ndarray[_AnyShape, dtype[long]]], Any, None]:
        """Generate indices to split data into training and test set.
