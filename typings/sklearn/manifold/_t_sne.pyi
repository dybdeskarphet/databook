...
class TSNE(ClassNamePrefixFeaturesOutMixin, TransformerMixin, BaseEstimator):
    ...
    _N_ITER_CHECK = ...
    def __init__(self, n_components=..., *, perplexity=..., early_exaggeration=..., learning_rate=..., max_iter=..., n_iter_without_progress=..., min_grad_norm=..., metric=..., metric_params=..., init=..., verbose=..., random_state=..., method=..., angle=..., n_jobs=...) -> None:
        ...
