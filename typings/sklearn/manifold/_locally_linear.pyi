...
def barycenter_weights(X, Y, indices, reg=...): # -> _Array[tuple[int, int], float64]:
...
def null_space(M, k, k_skip=..., eigen_solver=..., tol=..., max_iter=..., random_state=...): # -> tuple[Any | ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]], float64] | tuple[Any, Any]:
    """
...
def locally_linear_embedding(X, *, n_neighbors, n_components, reg=..., eigen_solver=..., tol=..., max_iter=..., method=..., hessian_tol=..., modified_tol=..., random_state=..., n_jobs=...): # -> tuple[Any | ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]], float64] | tuple[Any, Any]:
