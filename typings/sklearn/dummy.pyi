...
class DummyClassifier(MultiOutputMixin, ClassifierMixin, BaseEstimator):
    ...
    def predict(self, X): # -> csc_matrix | _Array1D[Any] | NDArray[Any]:
...
class DummyRegressor(MultiOutputMixin, RegressorMixin, BaseEstimator):
    ...
    def predict(self, X, return_std=...): # -> tuple[_Array1D[Any] | ndarray[tuple[int, int], dtype[Any]], _Array1D[float64] | _Array[tuple[int, int], float64]] | _Array1D[Any] | ndarray[tuple[int, int], dtype[Any]]:
        """Perform classification on test vectors X.
