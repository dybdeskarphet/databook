...
class BaseGradientBoosting(BaseEnsemble, metaclass=ABCMeta):
    ...
    @property
    def feature_importances_(self): # -> _Array1D[float64] | float64 | NDArray[float64]:
...
class GradientBoostingClassifier(ClassifierMixin, BaseGradientBoosting):
    ...
    def staged_decision_function(self, X): # -> Generator[_Array[tuple[int, int], float64] | Any, Any, None]:
    ...
    def predict(self, X): # -> ndarray[_AnyShape, dtype[Any]] | Any | None:
        """Predict class for X.
    ...
    def staged_predict(self, X): # -> Generator[ndarray[_AnyShape, dtype[Any]] | Any, Any, None]:
...
class GradientBoostingRegressor(RegressorMixin, BaseGradientBoosting):
    ...
    def staged_predict(self, X): # -> Generator[ndarray[tuple[int], dtype[float64]] | Any, Any, None]:
