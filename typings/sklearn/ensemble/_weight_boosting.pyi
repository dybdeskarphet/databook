...
class AdaBoostClassifier(_RoutingNotSupportedMixin, ClassifierMixin, BaseWeightBoosting):
    ...
    def staged_decision_function(self, X): # -> Generator[Any | NDArray[float64], Any, None]:
    ...
    def predict_proba(self, X): # -> _Array[tuple[int, int], float64] | Any:
...
class AdaBoostRegressor(_RoutingNotSupportedMixin, RegressorMixin, BaseWeightBoosting):
    ...
    def staged_predict(self, X): # -> Generator[ndarray[_AnyShape, dtype[Any]], Any, None]:
        """Return staged predictions for X.
