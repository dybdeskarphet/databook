...
class LinearModelLoss:
    ...
    def loss_gradient(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=..., raw_prediction=...): # -> tuple[Any, Any | ndarray[tuple[int], dtype[float64]] | _Array[tuple[int, int], float64]]:
    ...
    def gradient(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=..., raw_prediction=...): # -> ndarray[tuple[int], dtype[float64]] | _Array[tuple[int, int], float64]:
    ...
    def gradient_hessian(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=..., gradient_out=..., hessian_out=..., raw_prediction=...): # -> tuple[Any, _Array[tuple[int, int], float64] | Any, Any] | tuple[Any, _Array[tuple[int, int], float64] | Any, Any | Literal[False]]:
    ...
    def gradient_hessian_product(self, coef, X, y, sample_weight=..., l2_reg_strength=..., n_threads=...): # -> tuple[ndarray[tuple[int], dtype[float64]], Callable[..., ndarray[tuple[int], dtype[float64]] | _Array[tuple[int, int], float64]]] | tuple[Any | _Array[tuple[int, int], float64], Callable[..., Any]]:
