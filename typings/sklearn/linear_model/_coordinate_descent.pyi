...
def lasso_path(X, y, *, eps=..., n_alphas=..., alphas=..., precompute=..., Xy=..., copy_X=..., coef_init=..., verbose=..., return_n_iter=..., positive=..., **params): # -> tuple[_Array[tuple[int], floating[_64Bit]] | Any | ndarray[_AnyShape, dtype[Any]], _Array[tuple[int, int], float64] | _Array[tuple[int, int, int], float64], _Array1D[float64], list[Any]] | tuple[_Array[tuple[int], floating[_64Bit]] | Any | ndarray[_AnyShape, dtype[Any]], _Array[tuple[int, int], float64] | _Array[tuple[int, int, int], float64], _Array1D[float64]]:
...
def enet_path(X, y, *, l1_ratio=..., eps=..., n_alphas=..., alphas=..., precompute=..., Xy=..., copy_X=..., coef_init=..., verbose=..., return_n_iter=..., positive=..., check_input=..., **params): # -> tuple[_Array[tuple[int], floating[_64Bit]] | Any | ndarray[_AnyShape, dtype[Any]], _Array[tuple[int, int], float64] | _Array[tuple[int, int, int], float64], _Array1D[float64], list[Any]] | tuple[_Array[tuple[int], floating[_64Bit]] | Any | ndarray[_AnyShape, dtype[Any]], _Array[tuple[int, int], float64] | _Array[tuple[int, int, int], float64], _Array1D[float64]]:
