...
def mean_shift(X, *, bandwidth=..., seeds=..., bin_seeding=..., min_bin_freq=..., cluster_all=..., max_iter=..., n_jobs=...): # -> tuple[ndarray[_AnyShape, dtype[Any]], Any | _Array1D[Any]]:
...
class MeanShift(ClusterMixin, BaseEstimator):
    ...
    def predict(self, X): # -> NDArray[floating[Any]]:
