...
def kmeans_plusplus(X, n_clusters, *, sample_weight=..., x_squared_norms=..., random_state=..., n_local_trials=...): # -> tuple[_Array[tuple[int, int], float64], _Array[tuple[int], Any]]:
...
def k_means(X, n_clusters, *, sample_weight=..., init=..., n_init=..., max_iter=..., verbose=..., tol=..., random_state=..., copy_x=..., algorithm=..., return_n_iter=...): # -> tuple[Any, _Array[tuple[int], signedinteger[_32Bit]] | None, Any | None, int] | tuple[Any, _Array[tuple[int], signedinteger[_32Bit]] | None, Any | None]:
...
class _BaseKMeans(ClassNamePrefixFeaturesOutMixin, TransformerMixin, ClusterMixin, BaseEstimator, ABC):
    ...
    def predict(self, X): # -> tuple[_Array[tuple[int], signedinteger[_32Bit]], Any] | _Array[tuple[int], signedinteger[_32Bit]]:
    ...
    def score(self, X, y=..., sample_weight=...): # -> signedinteger[_32Bit]:
