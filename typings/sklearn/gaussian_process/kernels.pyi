...
class NormalizedKernelMixin:
    ...
    .. versionadded:: 0.18
    """
    def diag(self, X): # -> _Array1D[float64]:
        """Returns the diagonal of the kernel k(X, X).
...
class CompoundKernel(Kernel):
    ...
    def is_stationary(self): # -> numpy.bool[builtins.bool]:
        """Returns whether the kernel is stationary."""
        ...
    
    @property
    def requires_vector_input(self): # -> numpy.bool[builtins.bool]:
...
class ConstantKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[ndarray[tuple[int, int], dtype[Any]], ndarray[tuple[int, int, int], dtype[Any]]] | tuple[ndarray[tuple[int, int], dtype[Any]], _Array[tuple[int, int, int], float64]] | ndarray[tuple[int, int], dtype[Any]]:
        """Return the kernel k(X, Y) and optionally its gradient.
    ...
    def diag(self, X): # -> ndarray[tuple[int], dtype[Any]]:
        """Returns the diagonal of the kernel k(X, X).
...
class WhiteKernel(StationaryKernelMixin, GenericKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[float64], NDArray[float64]] | tuple[NDArray[float64], _Array[tuple[int, int, int], float64]] | NDArray[float64] | _Array[tuple[int, int], float64]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class RBF(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    @property
    def anisotropic(self): # -> TypeIs[Iterable[Any]] | bool:
        ...
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any], _Array[tuple[int, int, int], float64]] | tuple[NDArray[Any], ndarray[_AnyShape, dtype[Any]]] | tuple[NDArray[Any], Any] | NDArray[Any] | None:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class Matern(RBF):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[float64] | Any, _Array[tuple[int, int, int], float64]] | tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[float64] | Any, _Array[tuple[int, int, int], Any]] | tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[float64] | Any, Any] | tuple[NDArray[Any] | NDArray[floating[Any]] | NDArray[float64] | Any, Any | NDArray[Any] | NDArray[floating[Any]] | NDArray[float64]] | NDArray[Any] | NDArray[floating[Any]] | NDArray[float64] | Any:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class RationalQuadratic(StationaryKernelMixin, NormalizedKernelMixin, Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[NDArray[float64] | NDArray[floating[Any]], NDArray[floating[Any]]] | NDArray[float64] | NDArray[floating[Any]]:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class DotProduct(Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[Any, _Array[tuple[int, int, int], float64]] | Any:
        """Return the kernel k(X, Y) and optionally its gradient.
...
class PairwiseKernel(Kernel):
    ...
    def __call__(self, X, Y=..., eval_gradient=...): # -> tuple[Any, _Array[tuple[int, int, int], float64]] | tuple[Any, _Array[tuple[int, int, int], Any]]:
        """Return the kernel k(X, Y) and optionally its gradient.
    ...
    def diag(self, X): # -> ndarray[tuple[int], dtype[float64]]:
        """Returns the diagonal of the kernel k(X, X).
