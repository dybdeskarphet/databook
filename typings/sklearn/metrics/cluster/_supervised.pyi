...
def contingency_matrix(labels_true, labels_pred, *, eps=..., sparse=..., dtype=...): # -> csr_array:
...
def pair_confusion_matrix(labels_true, labels_pred): # -> _Array[tuple[int, int], signedinteger[_64Bit]]:
