...
def average_precision_score(y_true, y_score, *, average=..., pos_label=..., sample_weight=...): # -> float | _Array[tuple[int], float64] | Literal[0]:
...
def det_curve(y_true, y_score, pos_label=..., sample_weight=..., drop_intermediate=...): # -> tuple[Any, Any, ndarray[_AnyShape, dtype[Any]]]:
...
def roc_auc_score(y_true, y_score, *, average=..., sample_weight=..., max_fpr=..., multi_class=..., labels=...): # -> floating[Any] | float | _Array[tuple[int], float64] | Literal[0]:
...
@validate_params({ "y_true": ["array-like"],"y_score": ["array-like"],"pos_label": [Real, str, "boolean", None],"sample_weight": ["array-like", None],"drop_intermediate": ["boolean"] }, prefer_skip_nested_validation=True)
def roc_curve(y_true, y_score, *, pos_label=..., sample_weight=..., drop_intermediate=...): # -> tuple[ndarray[tuple[int], dtype[Any]] | Any, ndarray[tuple[int], dtype[Any]] | Any, Incomplete]:
