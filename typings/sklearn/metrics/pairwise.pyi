...
def paired_distances(X, Y, *, metric=..., **kwds): # -> Any | _Array1D[float64] | None:
    """
...
def additive_chi2_kernel(X, Y=...): # -> _Array[tuple[int, int], float64] | Any:
...
def distance_metrics(): # -> dict[str, Callable[..., _Array[tuple[int, int], float64] | NDArray[floating[Any]]] | Callable[..., Any] | None]:
...
def pairwise_distances_chunked(X, Y=..., *, reduce_func=..., metric=..., n_jobs=..., working_memory=..., **kwds): # -> Generator[Any | NDArray[Any] | _Array[tuple[int, int], Any] | NDArray[floating[Any]] | _Array[tuple[int, int], float64], Any, None]:
...
def pairwise_distances(X, Y=..., metric=..., *, n_jobs=..., force_all_finite=..., ensure_all_finite=..., **kwds): # -> NDArray[Any] | _Array[tuple[int, int], Any] | NDArray[floating[Any]] | Any | _Array[tuple[int, int], float64]:
...
def kernel_metrics(): # -> dict[str, Callable[..., _Array[tuple[int, int], float64] | Any] | Callable[..., NDArray[Any] | Any] | Callable[..., Any]]:
...
def pairwise_kernels(X, Y=..., metric=..., *, filter_params=..., n_jobs=..., **kwds): # -> NDArray[Any] | _Array[tuple[int, int], Any] | Any | _Array[tuple[int, int], float64] | None:
