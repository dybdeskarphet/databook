...
class CalibratedClassifierCV(ClassifierMixin, MetaEstimatorMixin, BaseEstimator):
    ...
    def predict(self, X): # -> ndarray[_AnyShape, dtype[Any]] | Any:
...
class CalibrationDisplay(_BinaryClassifierCurveDisplayMixin):
    ...
    @classmethod
    def from_estimator(cls, estimator, X, y, *, n_bins=..., strategy=..., pos_label=..., name=..., ax=..., ref_line=..., **kwargs): # -> Self:
    ...
    @classmethod
    def from_predictions(cls, y_true, y_prob, *, n_bins=..., strategy=..., pos_label=..., name=..., ax=..., ref_line=..., **kwargs): # -> Self:
