...
class LabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    def fit_transform(self, y): # -> csr_matrix | ndarray[tuple[int, int], dtype[Any]]:
    ...
    def transform(self, y): # -> csr_matrix | ndarray[tuple[int, int], dtype[Any]]:
    ...
    def inverse_transform(self, Y, threshold=...): # -> csr_matrix | ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
...
def label_binarize(y, *, classes, neg_label=..., pos_label=..., sparse_output=...): # -> csr_matrix | ndarray[tuple[int, int], dtype[Any]]:
    """Binarize labels in a one-vs-all fashion.
...
class MultiLabelBinarizer(TransformerMixin, BaseEstimator, auto_wrap_output_keys=None):
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def fit_transform(self, y): # -> csr_matrix:
    ...
    def transform(self, y): # -> csr_matrix:
