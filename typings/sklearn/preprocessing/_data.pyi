...
class RobustScaler(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X): # -> str | tuple[str, str] | Any | tuple[Any, Any] | NDArray[float64] | NDArray[complex128]:
...
def normalize(X, norm=..., *, axis=..., copy=..., return_norm=...): # -> tuple[Any, Any | float | generic[Any] | complex | str | bytes | memoryview[int]]:
...
class Normalizer(OneToOneFeatureMixin, TransformerMixin, BaseEstimator):
    ...
    def transform(self, X, copy=...): # -> tuple[Any, Any | float | generic[Any] | complex | str | bytes | memoryview[int]]:
