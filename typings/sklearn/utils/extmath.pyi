...
def randomized_range_finder(A, *, size, n_iter, power_iteration_normalizer=..., random_state=...): # -> NDArray[Any] | tuple[NDArray[Any], NDArray[Any]] | tuple[Any, Any] | Any:
...
def randomized_svd(M, n_components, *, n_oversamples=..., n_iter=..., power_iteration_normalizer=..., transpose=..., flip_sign=..., random_state=..., svd_lapack_driver=...): # -> tuple[Any | ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]], Any | ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]], Any | ndarray[_AnyShape, dtype[float64]] | ndarray[_AnyShape, dtype[Any]]]:
