...
class BaseLoss:
    ...
    def init_gradient_and_hessian(self, n_samples, dtype=..., order=...): # -> tuple[Any, _Array[tuple[int], float64] | Any]:
...
class HalfBinomialLoss(BaseLoss):
    ...
    def predict_proba(self, raw_prediction): # -> _Array[tuple[int, int], float64]:
...
class HalfMultinomialLoss(BaseLoss):
    ...
    def in_y_true_range(self, y): # -> numpy.bool[builtins.bool] | Literal[False]:
        """Return True if y is in the valid range of y_true.
