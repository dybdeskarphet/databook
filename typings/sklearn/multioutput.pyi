...
"""
__all__ = ["ClassifierChain", "MultiOutputClassifier", "MultiOutputRegressor", "RegressorChain"]
class _MultiOutputEstimator(MetaEstimatorMixin, BaseEstimator, metaclass=ABCMeta):
    ...
    def partial_fit(self, X, y, classes=..., sample_weight=..., **partial_fit_params): # -> Self:
...
class MultiOutputRegressor(RegressorMixin, _MultiOutputEstimator):
    ...
    @_available_if_estimator_has("partial_fit")
    def partial_fit(self, X, y, sample_weight=..., **partial_fit_params): # -> None:
...
class _BaseChain(BaseEstimator, metaclass=ABCMeta):
    _parameter_constraints: dict = ...
    def __init__(self, estimator=..., *, order=..., cv=..., random_state=..., verbose=..., base_estimator=...) -> None:
        ...
    ...
    def predict(self, X): # -> ndarray[_AnyShape, dtype[float64]]:
...
class ClassifierChain(MetaEstimatorMixin, ClassifierMixin, _BaseChain):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, estimator=..., *, order=..., cv=..., chain_method=..., random_state=..., verbose=..., base_estimator=...) -> None:
        ...
    ...
    def predict_proba(self, X): # -> ndarray[_AnyShape, dtype[float64]]:
