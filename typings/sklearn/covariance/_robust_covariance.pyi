...
"""
def c_step(X, n_support, remaining_iterations=..., initial_estimates=..., verbose=..., cov_computation_method=..., random_state=...): # -> tuple[Any, Any, Any | float, ndarray[_AnyShape, dtype[Any]], Any | float]:
...
def select_candidates(X, n_support, n_trials, select=..., n_iter=..., verbose=..., cov_computation_method=..., random_state=...): # -> tuple[ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]], ndarray[_AnyShape, dtype[Any]]]:
...
def fast_mcd(X, support_fraction=..., cov_computation_method=..., random_state=...): # -> tuple[Any | NDArray[Any], Any | NDArray[floating[Any]], _Array1D[Any] | Any, _Array1D[float64] | Any]:
...
class MinCovDet(EmpiricalCovariance):
    ...
    def reweight_covariance(self, data): # -> tuple[_Array1D[float64] | Any, NDArray[Any] | Any, _Array1D[Any]]:
