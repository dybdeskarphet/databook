...
def sparse_encode(X, dictionary, *, gram=..., cov=..., algorithm=..., n_nonzero_coefs=..., alpha=..., copy_cov=..., init=..., max_iter=..., n_jobs=..., check_input=..., verbose=..., positive=...): # -> ndarray[tuple[int, int], dtype[float64]] | ndarray[tuple[int, int], dtype[Any]] | Any:
    """Sparse coding.
...
class DictionaryLearning(_BaseSparseCoding, BaseEstimator):
    ...
    def fit_transform(self, X, y=...): # -> ndarray[tuple[int, int], dtype[float64]] | ndarray[tuple[int, int], dtype[Any]] | Any | ndarray[_AnyShape, dtype[Any]]:
