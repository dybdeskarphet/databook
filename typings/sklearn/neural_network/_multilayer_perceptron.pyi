...
class MLPClassifier(ClassifierMixin, BaseMultilayerPerceptron):
    ...
    def predict(self, X): # -> csr_matrix | ndarray[_AnyShape, dtype[Any]] | ndarray[tuple[int], dtype[Any]] | NDArray[Any]:
    ...
    @_fit_context(prefer_skip_nested_validation=True)
    def partial_fit(self, X, y, sample_weight=..., classes=...): # -> Self:
    ...
    def predict_proba(self, X): # -> NDArray[Any] | Any | str | tuple[str, str] | tuple[Any, Any]:
...
class MLPRegressor(RegressorMixin, BaseMultilayerPerceptron):
    ...
    """
    _parameter_constraints: dict = ...
    def __init__(self, loss=..., hidden_layer_sizes=..., activation=..., *, solver=..., alpha=..., batch_size=..., learning_rate=..., learning_rate_init=..., power_t=..., max_iter=..., shuffle=..., random_state=..., tol=..., verbose=..., warm_start=..., momentum=..., nesterovs_momentum=..., early_stopping=..., validation_fraction=..., beta_1=..., beta_2=..., epsilon=..., n_iter_no_change=..., max_fun=...) -> None:
        ...
    
    def predict(self, X): # -> Any | str | tuple[str, str] | tuple[Any, Any]:
