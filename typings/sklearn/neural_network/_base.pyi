...
DERIVATIVES = ...
def squared_loss(y_true, y_pred, sample_weight=...): # -> Any:
...
def poisson_loss(y_true, y_pred, sample_weight=...): # -> Incomplete:
...
def log_loss(y_true, y_prob, sample_weight=...): # -> Incomplete:
...
def binary_log_loss(y_true, y_prob, sample_weight=...): # -> Incomplete:
